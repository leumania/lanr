    ...
    <body class="min-h-screen bg-[#f5f7f9] antialiased">
        <div class="grid min-h-svh lg:grid-cols-[1.05fr_0.95fr]">
            <section class="hidden flex-col justify-between bg-gradient-to-br from-[#10283c] to-[#183950] px-14 py-12 text-white lg:flex">
                <div class="flex items-center gap-3.5 border-b border-white/10 pb-6">
                ...
                <div class="max-w-[540px]">
                    <span class="mb-4 inline-block rounded-full border border-white/20 bg-white/10 px-3 py-1.5 text-[11px] text-[#d8e2e9]">
                        Plataforma corporativa
                    </span>

                    <h1 class="mb-4 text-[40px] leading-[1.15] font-bold tracking-tight text-white">
                ...
                <div>
                    <div class="grid grid-cols-[1.5fr_0.65fr_1fr] gap-7 border-t border-white/10 pt-5">
                        <div>
            ...
            <section class="grid place-items-center p-7">
                <div class="w-full max-w-[430px] rounded-2xl border border-[#dde5ea] bg-white p-8 shadow-[0_12px_35px_rgba(19,48,69,0.06)]">
                    {{ $slot }}
                </div>
            </section>
        </div>
