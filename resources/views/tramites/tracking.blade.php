<x-layouts::app :title="__('Seguimiento ' . $tramite->tracking)">
    <div class="space-y-4">
        ...
        <flux:card>
            <flux:heading size="lg" class="mb-4">Historial del trámite</flux:heading>
            <div class="flex flex-col gap-4">
                @forelse ($tramite->history->sortByDesc('created_at') as $evento)
                    <div class="flex gap-3 border-b border-zinc-100 pb-4 last:border-0 dark:border-zinc-800">
